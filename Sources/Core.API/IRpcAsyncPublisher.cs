...
namespace MessageBus.Core.API
{
    ...
    public interface IRpcAsyncPublisher : IPublisher
    {
        ...
        Task<TReplyData> Send<TData, TReplyData>(TData data, CancellationToken cancellationToken, bool persistant = false);
        ...
        Task Send<TData>(TData data, CancellationToken cancellationToken, bool persistant = false);
        ...
        Task<BusMessage<TReplyData>> Send<TData, TReplyData>(BusMessage<TData> message, CancellationToken cancellationToken, bool persistant = false);
        ...
        /// <param name="persistant"></param>
        /// <remarks>Message returned without any content, or if content exists it is not deserialize</remarks>
        Task Send<TData>(BusMessage<TData> message, CancellationToken cancellationToken, bool persistant = false);
    }
}