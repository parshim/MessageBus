...
namespace MessageBus.Core.API
{
    ...
    public interface ISubscriber : ISubscription
    {
        ...
        /// <returns>True if successfully subscribed, otherwise false.</returns>
        /// <exception cref="SubscriptionClosedException"></exception>
        bool Subscribe<TData, TReplyData>(Func<TData, TReplyData> callback, bool hierarchy = false, IEnumerable<BusHeader> filter = null);
        ...
        /// <returns>True if successfully subscribed, otherwise false.</returns>
        /// <exception cref="SubscriptionClosedException"></exception>
        bool Subscribe<TData, TReplyData>(Func<BusMessage<TData>, BusMessage<TReplyData>> callback, bool hierarchy = false, IEnumerable<BusHeader> filter = null);
